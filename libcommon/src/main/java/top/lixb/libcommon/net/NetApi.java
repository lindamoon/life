...
public interface NetApi {
    ...
    @POST
    @FormUrlEncoded()
    Observable<ResponseBody> commonPostRequest(@Url String url, @FieldMap Map<String, String> params,@HeaderMap Map<String,String> headers);
    ...
    @GET
    Observable<ResponseBody> commonGetRequest(@Url String url, @QueryMap Map<String, String> params, @HeaderMap Map<String,String> headers);
    @GET
